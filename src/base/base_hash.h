...
\
internal name *name##_new(Arena *arena, usize n)                         \
{                                                                            \
...
\
internal bool name##_insert(name *map, u32 key, value_t value) \
{                                                                  \
...
\
internal bool name##_get(name *map, u32 key, value_t *out)     \
{                                                                  \
	usize idx = hash32(key) % map->capacity;                         \
	usize start = idx;                                               \
	while(map->entries[idx].occupied) {                              \
